...
export const ProfilePreviewModal = memo(({
    ...
    return (
        <AnimatePresence>
            <div
                className="absolute inset-0 z-50 bg-black/60 backdrop-blur-md overflow-hidden min-w-0 flex items-center justify-center"
            ...
            >
                <motion.div
                    ...
                    className="relative w-[calc(100%-1.5rem)] max-w-[350px] min-w-0 bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-3xl p-4 sm:p-5 shadow-2xl flex flex-col space-y-3 sm:space-y-4 max-h-[calc(100%-1.5rem)] overflow-y-auto select-none shrink-0 transition-colors duration-300"
                >
                    <button
                        type="button"
                        onClick={handleCloseModal}
