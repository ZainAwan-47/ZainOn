        ...
        <div className="flex flex-col space-y-2 p-1 select-none">
            ...
            <div className="flex items-center justify-between px-2 py-1">
                ...
                <button
                    ...
                    className="py-1 px-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold transition-all shadow-md active:scale-95 flex items-center space-x-1 cursor-pointer"
                >
            ...
            {groups.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 px-4 text-center space-y-2">
                    ...
                    <span className="text-xs font-bold text-slate-300">Create your first group.</span>
