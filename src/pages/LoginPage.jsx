    ...
    return (
        <div className="w-full max-w-md bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-3xl shadow-2xl p-6 sm:p-8 transition-all duration-300">
            <div className="lg:hidden flex flex-col items-center text-center mb-6">
                ...
                <span className="text-xl font-bold tracking-tight text-[var(--text-primary)] mb-2">ZainOn</span>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="flex items-center justify-between pt-1">
                        ...
                        <Link to="/forgot-password" className="text-xs font-medium text-[var(--color-primary)] hover:underline focus:outline-none">
                            Forgot Password?
                        </Link>
                    </div>
                </div>
            ...
            {authError && (
                <div role="alert" className="mt-4 p-3.5 rounded-xl bg-[var(--color-danger)]/10 border border-[var(--color-danger)]/30 text-[var(--color-danger)] text-xs flex items-center space-x-2">
            ...
            <div className="relative my-6 flex items-center justify-center">
                ...
                <span className="absolute bg-[var(--bg-surface)] px-3 text-xs font-semibold uppercase tracking-wider text-[var(--text-secondary)]">OR</span>
            </div>
            ...
            <p className="text-center text-xs text-[var(--text-secondary)] mt-6">
                ...
                <Link to="/register" className="font-semibold text-[var(--color-primary)] hover:underline focus:outline-none">
                    Create Account
                </Link>
            </p>
        </div>
