...
export const AuthLayout = () => {
    ...
    return (
        <div className="fixed inset-0 h-screen w-screen overflow-hidden theme-navy bg-[var(--bg-main)] relative select-none transition-colors duration-300">
            {/* Desktop 50% Sliding Hero Gradient Panel (Slower 900ms Glide) */}
            <div
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center justify-center max-w-sm px-4">
                                ...
                                <p className="text-sm lg:text-base text-white/90 font-medium leading-snug mt-1.5">
                                    {content.subtitle}
                                </p>
                            </div>
            ...
            {/* Form Canvas Container with Unhurried Fluid Glide */}
            <div
            ...
            >
                <div
                    ...
                    style={{
                        animation: 'authSmoothMorph 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards'
                    }}
                >
                    <Outlet />
                </div>
            ...
            {/* Custom Butter-Smooth Keyframes */}
            <style>{`
